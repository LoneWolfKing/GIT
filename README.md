...
Lightweight Tags
Another way to tag commits is with a lightweight tag. This is basically the commit checksum stored in a file ¨C no other information is kept. To create a lightweight tag, don¡¯t supply the -a, -s, or -m option:
...
...
Sharing Tags
By default, the git push command doesn¡¯t transfer tags to remote servers. You will have to explicitly push tags to a shared server after you have created them. This process is just like sharing remote branches ¨C you can run git push origin [tagname].
